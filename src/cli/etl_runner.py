...
def main(argv: list[str] | None = None) -> int:
    ...
    # lightweight guard: warn if repository source contains CUTOVER/TZ flags
    try:
        from lib.io_guards import guard_no_cutover_flags

        guard_no_cutover_flags()
    except Exception:
        # do not block execution on guard failures
        pass
