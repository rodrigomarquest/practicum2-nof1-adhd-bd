...
- **Fold 5** (2023-09-16 → 2023-11-16): F1=0.5567, BA=0.5280
...
- **Mean Macro-F1**: 0.2692

### Per-Fold LSTM Results

- **Fold 1**: F1=0.2095, Loss=1.0171, Acc=0.4583
- **Fold 2**: F1=0.3904, Loss=0.8466, Acc=0.6875
- **Fold 3**: F1=0.2029, Loss=1.3814, Acc=0.4375
- **Fold 4**: F1=0.3030, Loss=0.7214, Acc=0.8333
- **Fold 5**: F1=0.2400, Loss=1.1570, Acc=0.5625
...
- **ML6 Clean**: data\etl\P000001\2025-11-07\joined\features_nb2_clean.csv
- **Segments**: data\etl\P000001\2025-11-07\segment_autolog.csv
- **ML6 CV Summary**: data\ai\P000001\2025-11-07\nb2\cv_summary.json
