...
See top-level `make_scripts/intake_zip.py` for usage and behavior notes; this
is the authoritative implementation moved into the `make_scripts.intake`
package so the top-level script can be a small compatibility shim.
"""
