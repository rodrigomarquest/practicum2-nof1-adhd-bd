#!/usr/bin/env python3
"""Makefile-friendly cleanup helper moved into utils package.

This module implements the same behavior previously present at
`make_scripts/clean_data_make.py` but lives under `make_scripts.utils` as
the canonical implementation. Top-level shim will delegate to this.
"""
